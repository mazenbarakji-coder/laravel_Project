...
class ProductAddRequest extends Request
{
    ...
    public function rules(): array
    {
        return [
            ...
            'shipping_cost' => 'nullable|gt:-1',
            'code' => 'nullable|regex:/^[a-zA-Z0-9]+$/' . '|' . 'min' . ':6|' . 'max' . ':20|' . 'unique' . ':products',
    ...
    public function after(): array
    {
        return [
            function (Validator $validator) {
                ...
                if (($this['product_type'] ?? 'physical') == 'physical' && $this['unit_price'] <= $this->getDiscountAmount(price: $this['unit_price'] ?? 0, discount: $this['discount'], discountType: $this['discount_type'])) {
                    $validator->errors()->add(
                ...
                if (($this['product_type'] ?? 'physical') == 'physical' && ($this->has('colors') || ($this->has('choice_attributes') && count($this['choice_attributes']) > 0))) {
                ...
                if (($this['product_type'] ?? 'physical') == 'digital') {
