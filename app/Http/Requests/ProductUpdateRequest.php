    ...
    public function after(): array
    {
        return [
            function (Validator $validator) {
                ...
                if (($this['product_type'] ?? 'physical') == 'physical' && $this['unit_price'] <= $this->getDiscountAmount(price: $this['unit_price'], discount: $this['discount'], discountType: $this['discount_type'])) {
                    $validator->errors()->add(
